      ...
      : hasAnyEffect(character, ["gagveryheavy", "gagheavy", "gaggedheavy"])
        ...
        : hasAnyEffect(character, ["gagmedium", "gag", "gagged"])
          ...
          : hasAnyEffect(character, ["gaglight"])
            ? 1
            : 0;
    const resolvedLevel = cannotTalk && gagLevel < 4 ? 4 : gagLevel;
    const speechMode = resolvedLevel >= 4
      ? "moan"
      : resolvedLevel === 3
        ? "short"
        : resolvedLevel === 2
          ...
          : resolvedLevel === 1
            ? "light"
            : "clear";
    const gagged = resolvedLevel > 0 || cannotTalk;
    return { gagged, gagLevel: resolvedLevel, speechMode, cannotTalk };
  }
